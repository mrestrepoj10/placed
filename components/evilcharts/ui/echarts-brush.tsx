  ...
  return [
    {
      ...
      // PATCHED from upstream's "35%". handleSize is a fraction of the brush
      // strip's height, and this timeline's strip is short, so 35% left each
      // handle about a 5px-wide hit zone — measured, and unusable on touch.
      // The handles are invisible (handleStyle.opacity is 0), so this only
      // grows the grab target; nothing moves on screen.
      handleSize: "70%",
